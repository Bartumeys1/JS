...
class GameOfThron {
    characters =[
      ...
      SetInfo(element)
      {
       ...
       const divText_Img=document.createElement("div");
       const wrapper=document.createElement("div");
       wrapper.setAttribute("class","wrapp");
     
       //Image and text
         divText_Img.setAttribute("class","image_wrapper");
     
     
       const ImgTitle=document.createElement("h3");
       ImgTitle.innerHTML=element.fullName;
     
       const characterImgUrl = document.createElement("img");
       characterImgUrl.setAttribute("src", element.imageUrl);
       characterImgUrl.setAttribute("alt", "Character");
       divText_Img.appendChild(ImgTitle);
       divText_Img.appendChild(characterImgUrl);
     
       //Info
       const info=document.createElement("div");
     
       const infoText = document.createElement("p");
       infoText.innerHTML=`ID: ${element.id}<br>
                         First Name: ${element.firstName}<br>
                         Last Name: ${element.lastName}<br>
                         Full Name: ${element.fullName}<br>
       ...
       wrapper.appendChild(divText_Img);
      ...
      ShowAll()
      {
        this.characters.forEach(element => this.SetInfo(element));
      }
  }
  ...
  const character=document.getElementById("characterUI");
  console.log(character);

  //Title
  const title = document.createElement("h2");
  title.innerHTML="Character Detail";
  character.appendChild(title);

  const characterDetail=document.createElement("div");
  characterDetail.setAttribute("id","container");
  character.appendChild(characterDetail);


const gameOfThron = new GameOfThron();
gameOfThron.ShowAll();
